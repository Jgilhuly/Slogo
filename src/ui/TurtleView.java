...
/**
 * Takes in changes from the TurtleModel class in the back-end and reflect
 * changes onto Turtle on screen
 * 
 * @author Kei Yoshikoshi & John Gilhuly
 *
 */
public class TurtleView implements Observer {
	...
	private void draw(double x1, double y1, double x2, double y2,
		...
		// should provide wrapping, but we were unable to fix a bug with the y
		// position
